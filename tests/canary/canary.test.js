...
describe("canary module", () => {
  ...
  // TODO: Implement these tests when canary module is ready
  // test("routes percentage of traffic to canary", async () => {});
  // test("routes header-matched traffic to canary", async () => {});
});
