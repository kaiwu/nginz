...
pub const Allocator = struct_internal_hooks;
pub extern fn cJSON_Version() [*c]const u8;
pub extern fn cJSON_Parse(value: [*c]const u8, alloc: [*c]Allocator) [*c]cJSON;
...
pub extern fn cJSON_PrintPreallocated(item: [*c]cJSON, buffer: [*c]u8, length: c_int, format: cJSON_bool, len: [*c]usize) cJSON_bool;
pub extern fn cJSON_Delete(item: [*c]cJSON, alloc: [*c]Allocator) void;
...
pub extern fn cJSON_CreateNull(alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_CreateTrue(alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_CreateFalse(alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_CreateBool(boolean: cJSON_bool, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_CreateNumber(num: f64, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_CreateString(string: [*c]const u8, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_CreateRaw(raw: [*c]const u8, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_CreateArray(alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_CreateObject(alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_CreateStringReference(string: [*c]const u8, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_CreateObjectReference(child: [*c]const cJSON, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_CreateArrayReference(child: [*c]const cJSON, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_CreateIntArray(numbers: [*c]const c_int, count: c_int, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_CreateFloatArray(numbers: [*c]const f32, count: c_int, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_CreateDoubleArray(numbers: [*c]const f64, count: c_int, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_CreateStringArray(strings: [*c]const [*c]const u8, count: c_int, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_AddItemToArray(array: [*c]cJSON, item: [*c]cJSON) cJSON_bool;
pub extern fn cJSON_AddItemToObject(object: [*c]cJSON, string: [*c]const u8, item: [*c]cJSON, alloc: [*c]Allocator) cJSON_bool;
pub extern fn cJSON_AddItemToObjectCS(object: [*c]cJSON, string: [*c]const u8, item: [*c]cJSON, alloc: [*c]Allocator) cJSON_bool;
pub extern fn cJSON_AddItemReferenceToArray(array: [*c]cJSON, item: [*c]cJSON, alloc: [*c]Allocator) cJSON_bool;
pub extern fn cJSON_AddItemReferenceToObject(object: [*c]cJSON, string: [*c]const u8, item: [*c]cJSON, alloc: [*c]Allocator) cJSON_bool;
...
pub extern fn cJSON_DeleteItemFromArray(array: [*c]cJSON, which: c_int, alloc: [*c]Allocator) void;
...
pub extern fn cJSON_DeleteItemFromObject(object: [*c]cJSON, string: [*c]const u8, alloc: [*c]Allocator) void;
pub extern fn cJSON_DeleteItemFromObjectCaseSensitive(object: [*c]cJSON, string: [*c]const u8, alloc: [*c]Allocator) void;
pub extern fn cJSON_InsertItemInArray(array: [*c]cJSON, which: c_int, newitem: [*c]cJSON) cJSON_bool;
pub extern fn cJSON_ReplaceItemViaPointer(parent: [*c]cJSON, item: [*c]cJSON, replacement: [*c]cJSON, alloc: [*c]Allocator) cJSON_bool;
pub extern fn cJSON_ReplaceItemInArray(array: [*c]cJSON, which: c_int, newitem: [*c]cJSON, alloc: [*c]Allocator) cJSON_bool;
pub extern fn cJSON_ReplaceItemInObject(object: [*c]cJSON, string: [*c]const u8, newitem: [*c]cJSON, alloc: [*c]Allocator) cJSON_bool;
pub extern fn cJSON_ReplaceItemInObjectCaseSensitive(object: [*c]cJSON, string: [*c]const u8, newitem: [*c]cJSON, alloc: [*c]Allocator) cJSON_bool;
pub extern fn cJSON_Duplicate(item: [*c]const cJSON, recurse: cJSON_bool, alloc: [*c]Allocator) [*c]cJSON;
...
pub extern fn cJSON_AddNullToObject(object: [*c]cJSON, name: [*c]const u8, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_AddTrueToObject(object: [*c]cJSON, name: [*c]const u8, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_AddFalseToObject(object: [*c]cJSON, name: [*c]const u8, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_AddBoolToObject(object: [*c]cJSON, name: [*c]const u8, boolean: cJSON_bool, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_AddNumberToObject(object: [*c]cJSON, name: [*c]const u8, number: f64, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_AddStringToObject(object: [*c]cJSON, name: [*c]const u8, string: [*c]const u8, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_AddRawToObject(object: [*c]cJSON, name: [*c]const u8, raw: [*c]const u8, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_AddObjectToObject(object: [*c]cJSON, name: [*c]const u8, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_AddArrayToObject(object: [*c]cJSON, name: [*c]const u8, alloc: [*c]Allocator) [*c]cJSON;
pub extern fn cJSON_SetNumberHelper(object: [*c]cJSON, number: f64) f64;
pub extern fn cJSON_SetValuestring(object: [*c]cJSON, valuestring: [*c]const u8, alloc: [*c]Allocator) [*c]u8;
pub extern fn cJSON_malloc(size: usize, alloc: [*c]Allocator) ?*anyopaque;
pub extern fn cJSON_free(object: ?*anyopaque, alloc: [*c]Allocator) void;
